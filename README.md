...
### Broletter
Self-adapting daily science newsletter powered by Gemini, arXiv, and Telegram.

Key engineering work:
- arXiv paper fetching with category-based filtering
- feedback-driven adaptation loop (reaction buttons → weight adjustments)
- static site generation with full-text search and knowledge map
- macOS LaunchAgent scheduling with idempotency guard

[Repo](https://github.com/landigf/Broletter) · [Live site](https://broletter-web-809582235088.europe-west6.run.app/) · [Blog post](https://landigf.github.io/Broletter-post.html)

---

### Autonomous Driving in TORCS
Behavioral cloning system using K-Nearest Neighbors with KD-Tree optimization.

Key engineering work:
- feature extraction pipeline
- nearest-neighbor search acceleration
- robustness mechanisms (dynamic k, OOD detection)
